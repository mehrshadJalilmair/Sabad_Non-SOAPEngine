            ...
            if error == nil
            {
                if let _ = response as? HTTPURLResponse
                {
                    ...
                    do
                    {
                        ...
                        let mainDict1 = mainDict2.object(forKey: "DeleteStoreResponse") as! NSDictionary
                        let mainDict = mainDict1.object(forKey: "DeleteStoreResult") as! NSDictionary
                                ...
                                for res in _ress
                                {
                                    if res["Result"] as! Int == -1
                                    {
                                        DispatchQueue.main.async {
                                            ...
                                            let alert = UIAlertController(title: "", message: "ابتدا کالاهای فروشگاه را حذف کنید!", preferredStyle: UIAlertControllerStyle.alert)
